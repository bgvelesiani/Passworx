...
fun ChangeMasterPasswordScreen(
    ...
    val viewState = remember { viewModel.viewState }.collectAsState()
    ...
    Scaffold {
        Column(
            ...
            ToolbarView(screenTitle = "Change Master Password") {
            ...
            Column(Modifier.padding(top = 16.dp, start = 16.dp, end = 16.dp)) {
                ...
                FlowRow(modifier = Modifier.fillMaxWidth()) {
                    viewState.value.validationErrors?.forEach { masterPasswordError ->
                ...
                if (viewState.value.changeSuccess) {
                    navController.navigateUp()
                }
            }
        }
